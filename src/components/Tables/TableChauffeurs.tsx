    ...
    return (
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
                ...
                <div className="col-span-1 flex items-center">
                    <p className="font-medium">Local de travail</p>
                </div>
                <div className="col-span-1 flex items-center">
            ...
            {chauffeurs.map((chauffeur, key) => (
                ...
                >
                    ...
                    <div className="col-span-1 flex items-center">
                        {chauffeur.commande ? (
                            <p className="text-sm text-meta-3">{chauffeur.commande.commandeprice}</p>
                        ) : (
                            <p className="text-sm text-meta-3">N/A</p>
                        )}
                    </div>
                    <div className="col-span-1 flex items-center">
                        {chauffeur.commande && chauffeur.commande.produit ? (
                            <p className="text-sm text-meta-3">{chauffeur.commande.produit.name}</p>
                        ) : (
                            <p className="text-sm text-meta-3">N/A</p>
                        )}
                    </div>
